...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create shwilliam-9139
  fly apps create shwilliam-9139-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app shwilliam-9139
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app shwilliam-9139-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'shwilliam-9139-staging' does not match app name in config file 'shwilliam-9139'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name shwilliam-9139-db
  fly postgres attach --app shwilliam-9139 shwilliam-9139-db

  fly postgres create --name shwilliam-9139-staging-db
  fly postgres attach --app shwilliam-9139-staging shwilliam-9139-staging-db
  ```
